...
<p align="center"> <img src="/images/michelle_detected.png" align="middle" alt="drawing" width="300px"> </p>
...
1. Clone the repository, and navigate to the downloaded folder. This may take a minute or two to clone due to the included image data.
	```
	git clone https://github.com/IntelSpectre/Facial-Keypoint-Detection.git
	```
